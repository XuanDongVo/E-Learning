  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <section className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        ...
        <button className="inline-flex h-10 items-center justify-center gap-2 rounded-[var(--radius-md)] bg-primary px-4 text-sm font-extrabold text-primary-foreground shadow-sm transition hover:bg-primary-hover">
      ...
      <section className="rounded-[var(--radius-md)] border border-border-color bg-card-bg p-5 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.14em] text-neutral-subtle">
              Assignments
            </p>
        ...
        <div className="mt-5 grid gap-3 md:grid-cols-3">
          <div className="rounded-[var(--radius-md)] bg-primary-light p-4">
            <p className="text-xs font-bold text-primary">Unit 2 Review</p>
            <p className="mt-2 text-xl font-extrabold">29 / 30</p>
            <p className="mt-1 text-xs text-neutral-muted">
              students completed
            </p>
          </div>
          <div className="rounded-[var(--radius-md)] bg-secondary-light p-4">
            <p className="text-xs font-bold text-secondary-hover">
              Grammar Practice
            </p>
            <p className="mt-2 text-xl font-extrabold">18 / 26</p>
            <p className="mt-1 text-xs text-neutral-muted">
              students completed
            </p>
          </div>
          <div className="rounded-[var(--radius-md)] bg-accent-light p-4">
            <p className="text-xs font-bold text-accent">Reading Review</p>
            <p className="mt-2 text-xl font-extrabold">12 / 24</p>
            <p className="mt-1 text-xs text-neutral-muted">
              students completed
            </p>
          </div>
