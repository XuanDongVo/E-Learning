  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-extrabold text-[#0F172A]">Units</h1>
          <p className="text-sm text-[#64748B]">Grade 6 Curriculum Catalog</p>
        </div>
      </div>
      <div className="rounded-2xl border border-[#E2E8F0] bg-white p-8 text-center space-y-3">
        <p className="text-[#64748B]">Module Units đang sẵn sàng để triển khai tiếp theo.</p>
        <Link href="/">
